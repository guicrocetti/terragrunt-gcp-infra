...
# TODO: add conditional permissions for argocd-sa-secret-accessor
...
locals {
  ...
  workload_identity_pool = "${local.account_vars.locals.project_id}.svc.id.goog" # should be better get this from the workload identity pool creation on project management folder
}
...
# Get kubernetes service account name and namespace
dependency "argocd" {
